...
class TestRegex(unittest.TestCase):
    ...
    def test_match(self):
        self.assertTrue(re.search(rrbot.what_regex,
                        'what is the rr?', re.IGNORECASE), "Should be True")

    def test_match_whats_the_rr(self):
        self.assertTrue(re.search(rrbot.what_regex, 'whats the rr',
                        re.IGNORECASE), "Should be True")

    def test_regex_match_rr(self):
        query = 'rr?'
        self.assertTrue(re.search(rrbot.what_regex, query,
                                 re.IGNORECASE), "Should be True")
    ...
    def test_regex_match_what_s_the_rr_quoted(self):
       query = '"what''s the rr?"'
       self.assertFalse(re.search(rrbot.what_regex, query,
                                 re.IGNORECASE), "Should be True")
